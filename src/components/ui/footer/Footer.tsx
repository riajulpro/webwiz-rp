    ...
    <footer className="bg-footer-color text-white">
      <div className="container-wrapper">
        <div className="footer-container pb-[42px]">
          <article className="flex flex-col tablet:flex-row justify-between pt-[32px] mb-[62px]">
          ...
          <article className="w-full flex-col desktop:flex-row flex items-start desktop:gap-[133px] tablet:gap-[32px]">
            ...
            <section className="desktop:w-[668px] flex flex-col tablet:flex-row items-start desktop:gap-[133px]">
              <div>
